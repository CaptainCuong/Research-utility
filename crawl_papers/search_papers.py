...
venues = ['acl','kdd','icdm','sdm','www','sigir','icde','mm']
...
venues = ['icml']
venues = ['nips']
venues = ['acl','kdd','emnlp']
venues = ['icassp']
venues = ['interspeech']
venues = ['iccv','eccv','cvpr']
venues = ['kdd','icdm','acl','emnlp']
venues = ['icml','nips','iclr','aaai']
venues = ['csur']
venues = ['all']
venues = ['acl','emnlp']
venues = ['icml','nips','iclr','aaai']
...
keywords = [['fast','efficient']]
keywords = [['time'],['ser']]
keywords = [['causal','treatment','confound','exchangeab','unmeasured','instrumental','survival']]
keywords = [['amortize']]
keywords = [['robust','adversa','attack']]
keywords = [['dataset','benchmark']]
keywords = [['revisit']]
keywords = [['robust'],['calibra']]
keywords = [['mixup','mix-up']]
keywords = [['whether','what',' is ','does','what','how','when','who','where','wrong','are','was ','were ']]
keywords = [['investi','demyst','rethink','toward','study','revisit']]
keywords = [['increment','continua']]
keywords = [['robust']]
keywords = [['unified']]
keywords = [['retrieval'],['momentum']]
keywords = [['active']]
keywords = [['fair']]
keywords = [['attack']]
keywords = [['defense']]
...
keywords = [['sgd','adamw','gradient','landscape']]
keywords = [['sharpness'],['aware']]
keywords = [['kv'],['cache']]
keywords = [['mixup','mix-up']]
keywords = [['reprogramming']]
keywords = [['diffusion']]
keywords = [['zero-shot']]
keywords = [['audio','music','speech','image','video']]
keywords = [['fake','deepfake']]
keywords = [['cross-atten']]
keywords = [['translation']]
keywords = [['speech','sound','music','audio']]
keywords = [['spectrum']]
keywords = [['compression']]
keywords = [['deepfake','machine-generated']]
keywords = [['adver'],['robust']]
keywords = [['fake'],['news']]
keywords = [['interpret'],['adversa']]
keywords = [['baye'],['optimiza']]
keywords = [['smooth'],['optimiza']]
keywords = [['Initializati']]
keywords = [['interpre','explana','explain']]
keywords = [['machine-gener','ai-gener','llm-gener']]
keywords = [['classifi'],['binary']]
ex_keywords = ['reinforce','actor','graph','bandit','bayesian','link','policy']
ex_keywords = []
'''
Keyword bank:
...
(local|decentralized|distributed|private|adaptive|asynchronous|implicit regularization) SGD, SGD (noise|dynamics|momentum), loss landscape
